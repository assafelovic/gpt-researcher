    ...
    <div className="relative overflow-visible min-h-[80vh] sm:min-h-[85vh] flex items-center pt-[120px] sm:pt-[140px] mt-[-60px] sm:mt-[-130px]">
      ...
      >
        ...
        >
          ...
          >
            <div className="mb-2 xs:mb-3 sm:mb-1 md:mb-0 text-white">Streamline Your Research</div>
            <span className="gradient-text-teal block" style={{ lineHeight: '1.2', paddingBottom: '0.1em' }}>
          ...
          <motion.div
            ...
            className="flex items-center justify-center gap-2 py-2 px-4 rounded-full bg-black/30 backdrop-blur-sm border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 shadow-sm hover:shadow-purple-900/20"
          >
            <div className="h-1.5 w-1.5 rounded-full bg-purple-400 animate-pulse mr-0.5"></div>
            <span className="text-gray-400 text-sm font-medium">Powered by</span>
            <a
              href="https://github.com/th3w1zard1"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white text-[15px] font-bold hover:underline hover:text-purple-300 transition-colors duration-200"
            >
              th3w1zard1
            </a>
          </motion.div>
