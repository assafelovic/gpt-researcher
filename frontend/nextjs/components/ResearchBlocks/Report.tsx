...
export default function Report({
  ...
  return (
    <div className="bg-black/28 container flex h-auto w-full shrink-0 gap-4 rounded-lg border border-solid border-teal-400/15 p-4 shadow-lg backdrop-blur-md sm:p-6">
      <div className="w-full">
        ...
        <div className="flex flex-wrap content-center items-center gap-[15px]">
          <div className="log-message w-full whitespace-pre-wrap text-base font-light leading-[1.72] text-white">
            {answer ? (
              <div
                className="markdown-content prose prose-invert prose-headings:scroll-mt-20 prose-headings:text-white prose-p:text-slate-100 prose-li:text-slate-100 max-w-none"
