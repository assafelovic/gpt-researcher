      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 mb-4 custom-scrollbar">
        {renderedMessages.length === 0 ? (
          <div className="text-center p-8 rounded-lg bg-gradient-to-r from-gray-900/5 to-gray-800/5 border border-gray-300/20 backdrop-blur-sm relative overflow-hidden">
            ...
            <h3 className="text-lg font-medium text-white mb-2">Stelle eine Frage zu diesem Forschungsbericht</h3>
            <p className="text-sm text-gray-400 max-w-md mx-auto">
              Die KI hat alle Inhalte analysiert und hilft dir jetzt, die Ergebnisse zu erkunden.
              Frage nach Zusammenfassungen oder gehe gezielt auf einzelne Themen ein.
            </p>
          </div>
        ) : (
          <>
