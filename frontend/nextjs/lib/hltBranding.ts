export const hltBranding = {
  ...
  subtitle: process.env.NEXT_PUBLIC_HLT_BRAND_SUBTITLE || "Katailyst research console",
  heroTitle:
    process.env.NEXT_PUBLIC_HLT_HERO_TITLE ||
    "Research anything with Mastery-grade context.",
  heroNote:
    process.env.NEXT_PUBLIC_HLT_HERO_NOTE ||
    "Source-backed web, codebase, CMS, and metrics research through GPT Researcher.",
