    ...
    <>
      ...
      {showScrollButton && showResult && (
        <button
          ...
          className="fixed bottom-8 right-8 z-50 flex h-12 w-12 transform items-center justify-center rounded-full bg-[rgb(168,85,247)] text-white shadow-lg transition-all duration-200 hover:scale-105 hover:bg-[rgb(147,51,234)]" aria-label="Scroll to bottom"
        >
          <svg
