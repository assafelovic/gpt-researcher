...
# These stubs are only needed while web_scraping.py is being loaded. Left in
# sys.modules they replace the real gpt_researcher package for every test
# module collected after this one, breaking the whole suite's collection.
# Snapshot here, restore once the load is done.
...
# Restore the real package; `ws` above is already bound.
