...
import os
import warnings
from typing import Any, ClassVar, Dict, List, Type, Union, get_args, get_origin
...
class Config:
    ...
    def __init__(
        ...
        if hasattr(self, "mcp_servers"):
            self.mcp_servers: list[dict[str, Any]] = self.mcp_servers
    ...
    def _handle_deprecated_attributes(self) -> None:
        ...
        if os.getenv("EMBEDDING_PROVIDER") is not None:
            ...
            match os.environ["EMBEDDING_PROVIDER"]:
                case "ollama":
                    self.embedding_model: str = os.environ["OLLAMA_EMBEDDING_MODEL"]
                case "custom":
    ...
    def parse_llm(llm_str: str | None) -> tuple[str | None, str | None]:
        ...
        Args:
            llm_str (str | None): The llm string to parse.

        Returns:
            tuple[str | None, str | None]: The llm provider and model.
        """
    ...
    def parse_embedding(embedding_str: str | None) -> tuple[str | None, str | None]:
        ...
        Args:
            embedding_str (str | None): The embedding string to parse.

        Returns:
            tuple[str | None, str | None]: The embedding provider and model.
        """
    ...
    def convert_env_value(
        ...
        Args:
            ...
            type_hint (Type): The type hint of the environment variable.

        Returns:
            Any: The converted value.
        """
        origin: type = get_origin(type_hint)
        args: list[type] = get_args(type_hint)  # type: ignore
    ...
    def set_verbose(self, verbose: bool) -> None:
        ...
        Args:
            verbose (bool): Whether to set the verbosity level.
        """
