...
- **By default, we use [Tavily Search API](https://app.tavily.com) (optimized for LLM research), but you can also revert to DuckDuckGo by changing the search provider in config/config.py.**
