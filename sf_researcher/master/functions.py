...
from sf_researcher.scraper.scraper import Scraper
...
def get_retriever(retriever):
    ...
    match retriever:
        case "tavily":
            from sf_researcher.retrievers import TavilySearch
            retriever = TavilySearch
        case "tavily_news":
            from sf_researcher.retrievers import TavilyNews
            retriever = TavilyNews
        case "google":
            from sf_researcher.retrievers import GoogleSearch
            retriever = GoogleSearch
        case "searx":
            from sf_researcher.retrievers import SearxSearch
            retriever = SearxSearch
        case "serpapi":
            raise NotImplementedError(
                "SerpApiSearch is not fully implemented yet.")
            from sf_researcher.retrievers import SerpApiSearch
            retriever = SerpApiSearch
        case "googleSerp":
            from sf_researcher.retrievers import SerperSearch
            retriever = SerperSearch
        case "duckduckgo":
            from sf_researcher.retrievers import Duckduckgo
            retriever = Duckduckgo
        case "BingSearch":
            from sf_researcher.retrievers import BingSearch
