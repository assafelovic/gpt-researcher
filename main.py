...
if __name__ == "__main__":
    ...
    if limit_concurrency and limit_concurrency.strip() and limit_concurrency.lower() != "null":
        limit_concurrency = int(limit_concurrency)
    else:
        limit_concurrency = None

    limit_max_requests = os.getenv("LIMIT_MAX_REQUESTS", "")
    if limit_max_requests and limit_max_requests.strip() and limit_max_requests.lower() != "null":
    ...
    logger.info("Uvicorn server successfully started")
