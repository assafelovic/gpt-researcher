...
RUN LATEST_CHROME_VERSION=$(google-chrome-stable --version | awk '{print $3}') \
    && CHROMEDRIVER_VERSION=$(curl -sS "https://chromedriver.storage.googleapis.com/LATEST_RELEASE_$LATEST_CHROME_VERSION") \
